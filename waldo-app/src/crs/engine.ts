 ...
 * PORTED FROM tools/health-parser/src/computed/crs-engine.ts — DO NOT MODIFY ALGORITHM.
 *
 ...
 * The 856-day validation is only valid against this exact logic.
 */
import type { DailyHealthData } from '@/types/health';
import type { CrsResult, ComponentScore, Baselines } from './types';
import { CRS_WEIGHTS, getCrsZone, getTimeOfDayRatio } from './types';
 ...
 * Requires historical data for baseline computation.
 *
 * Performance contract: pure synchronous computation.
 * All I/O (loading allDays) must happen BEFORE calling this function.
