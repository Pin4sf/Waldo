 ...
 * PORTED FROM tools/health-parser/src/computed/baseline-calculator.ts — DO NOT MODIFY ALGORITHM.
 *
 ...
 */
import type { DailyHealthData, SleepSession } from '@/types/health';
...
export function computeBaselines(
  ...
  const sleepSessions14d = lookback14.map(d => allDays.get(d)!.sleep ?? null);
